  ...
  return (
    <Section id="bio">
      ...
      <SectionText className="bio-text">
        ...
        to nabaľovalo až ku hudobnej produkcii a mixáži prvých pesničiek kapely
        Not Yet Awake (nájdete ju na spotify/youtube). Toto bol môj život asi do
        ...
        kúpiť moju prvú Sony kameru, objavil som další passion, ktorému som
        ihneď prepadol. Môj proces hľadania sa v tomto svete začal hudbou a
        teraz pokračuje videom. Nehovorím, že tu aj skončím, ale na teraz to je
        moja cesta. Momentálne končím posledný semester vysokej školy, riešim
        prestup z brigádnika na full-time a po víkendoch rád točím a strihám
        video. Veľká časť video produkcie, ktorá ma zhltla, je samotné farbenie
        a color grade. Ako mi to ide, môžeš pozrieť aj dole v projektoch. Ak tam
        toho moc nie je, znamená že tu si dosť skoro, a ešte som toho veľa
        nestihol, tak vitaj :). <br /> Verím, že toho bude čoskoro viac.
      </SectionText>
